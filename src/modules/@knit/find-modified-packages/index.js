...
type TFindModifiedPackages = (d: string, modu: TModules, modi: TModules) => Promise<TModules>;
export const findModifiedPackages: TFindModifiedPackages = (dir, modules, modified) => (
...
export const findModifiedSince: TFindModifiedSince = (dir, modules, tag) => {
  const output = execa.sync('git', ['diff', '--dirstat=files,0', tag, '--', dir]);
