...
export const updateModulePkg: TUpdateModulePkg = (modules, params) => {
  ...
  return ({
    ...
    ...params.pkg,
    ...{
      main: params.pkg.build === false ? 'index.js' : pathJoin(params.paths.distStub, params.paths.libStub, 'index.js'),
...
export const updateModulePkgBrowser: TUpdateModulePkgBrowser = (pkg, paths) => ({
  ...pkg,
  ...{
    'jsnext:main': pathJoin(paths.distStub, paths.jsnextStub, 'index.js'),
    module: pathJoin(paths.distStub, paths.jsnextStub, 'index.js'),
    unpkg: pathJoin(paths.distStub, paths.umdStub, 'index.min.js'),
  },
});
