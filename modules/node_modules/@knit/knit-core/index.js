...
export const updateModulePkg: TUpdateModulePkg = (modules, params) => {
  ...
  return ({
    ...
    ...params.pkg,
    ...{
      main: pathJoin(params.paths.libStub, 'index.js'),
...
export const updateModulePkgBrowser: TUpdateModulePkgBrowser = (pkg, paths) => ({
  ...pkg,
  ...{
    'jsnext:main': pathJoin(paths.jsnextStub, 'index.js'),
    module: pathJoin(paths.jsnextStub, 'index.js'),
    unpkg: pathJoin(paths.umdStub, 'index.min.js'),
  },
});
