...
exports.readPkg = (dir) => {
  try {
    ...
    throw {
      ...
      stderr: `All directories under ${needle.paths.modulesStub} are expected to be node modules. To ignore a directory add a 'ignore: true' to the package.json.`,
    };
  }
};
...
exports.findDependencies = (dir) => (
   depchek(path.join(needle.paths.modules, dir))
    ...
    .then(using => {
      ...
      return using.concat(deps).filter(d => !optDeps.includes(d));
    })
);
    ...
    Object.assign({},
      ...
      pkg,
      {
        ...
        peerDependencies: used.filter(d => (
          ...
          Object.assign(acc, {
            [d]: parseInt(exports.getPeerDependencyVersion(d, modules, updated, nextVersion), 10).toString(),
          })
        ), {}),
      }
    )
