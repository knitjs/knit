...
describe('updateModulePkg', () => {
  ...
  it('combines root package.json metadata with module package.json', () => {
    expect(ump(
      ...
      ...PKG,
      ...ROOT_PGK,
      main: path.join(PATHS.distStub, PATHS.libStub, 'index.js'),
      dependencies: {},
  ...
  it('does not add dist/ if package build:false', () => {
    const pkg = ump(
      { internal: [], used: [], updated: [] },
      {
        paths: PATHS,
...
describe('updateModulePkgBrowser', () => {
  ...
  it('adds `jsnext:main` and `browser` fields to package.json', () => {
    expect(umpb({ name: 'name' }, PATHS)).toEqual({
      name: 'name',
      'jsnext:main': path.join(PATHS.distStub, PATHS.jsnextStub, 'index.js'),
      module: path.join(PATHS.distStub, PATHS.jsnextStub, 'index.js'),
      unpkg: path.join(PATHS.distStub, PATHS.umdStub, 'index.min.js'),
    });
  });
