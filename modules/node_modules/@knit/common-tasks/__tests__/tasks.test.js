...
describe('public', () => {
  it('finds all public packages and set them to ctx.public and ctx.modules', async () => {
...
describe('modified', () => {
  it('finds modified packages to ctx.modified and ctx.modules', async () => {
    const ctx = await new Listr(modified, { renderer: SilentRenderer }).run({ public: PUBLIC });
    expect(ctx.public).toEqual(PUBLIC);
