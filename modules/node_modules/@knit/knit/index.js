...
exports.readPkg = (dir) => {
  try {
    ...
    throw `could not find a \`package.json\` in ${path.join(needle.paths.modulesStub, dir)}. All directories under ${needle.paths.modulesStub} are expected to be node modules. To ignore a directory add a 'private: true' to the package.json`;
  }
};
