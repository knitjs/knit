...
exports.buildModuleEs6 = (module) => (
   buildModule(
    ...
    { env: Object.assign({}, process.env, { JS_NEXT: true, NODE_ENV: 'production' }) }
  )
);

exports.buildModuleUmd = (module) => {
  const moduleDir = path.join(needle.paths.modules, module);

  return new Promise((resolve, reject) => webpack(webpackMerge(
    require('@knit/webpack-config-socks-lib'),
    {
      entry: path.join(moduleDir, 'index.js'),
      output: {
        library: upperCamelCase(knit.getModuleName(module)),
        path: path.join(moduleDir, needle.paths.distStub, needle.paths.umdStub),
...
exports.buildProjectUmd = (module) => (
  new Promise((resolve, reject) => webpack(webpackMerge(
