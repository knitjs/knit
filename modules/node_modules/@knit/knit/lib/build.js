...
const buildModuleUmd = (module, output, options) => {
  ...
  return execa('webpack', [
    ...
    '--output-library', upperCamelCase(knit.getModuleName(module)),
  ], options);
};

exports.buildModuleUmdSource = (module) =>
   buildModuleUmd(module, 'index.js', { env: Object.assign({}, process.env, { NODE_ENV: 'stage' }) })
;

exports.buildModuleUmdMin = (module) =>
   buildModuleUmd(module, 'index.min.js', { env: Object.assign({}, process.env, { NODE_ENV: 'production' }) })
;
