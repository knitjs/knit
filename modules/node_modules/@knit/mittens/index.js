...
const webpackConfig = require('@knit/webpack-config-socks-app/development');

import type { $Request, $Response } from 'express';

const host = needle.webpack.host;
const port = needle.webpack.port;
...
app.get(/^((?!(.js|.css|.ico)).)*$/, (req: $Request, res: $Response) => {
