...
exports.command = (...msg) => console.log(chalk.blue('command'), ...msg);
...
exports.missing = (...msg) => console.log(chalk.red('missing'), ...msg);
exports.subtree = (...msg) => console.log(chalk.white('└─'), ...msg);

exports.getRenderer = () => process.stdout.isTTY ? updateRdrr : verboseRdrr;
